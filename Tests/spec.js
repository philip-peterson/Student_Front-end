...
it('should update the application', function() {
  ...
  //app_edit.update_dropdown(1,'application.personal_info.address.permanent.state','CA');
  ...
  //app_edit.update_dropdown(1,'application.personal_info.address.current.state','CA');
